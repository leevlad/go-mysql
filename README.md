...
You can see [go-mysql-elasticsearch](https://github.com/leevlad/go-mysql-elasticsearch) for how to sync MySQL data into Elasticsearch.
...
```go
import (
    "github.com/leevlad/go-mysql/server"
    "net"
)
...
import (
    ...
    - "github.com/leevlad/go-mysql/driver"
)
